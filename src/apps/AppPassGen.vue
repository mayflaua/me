...
export default {
  ...
  mounted() {
    let button = $(".password-generate__button");
    let obj = $(".password__output");

    let optionsCheckboxes = $(".password__options");
